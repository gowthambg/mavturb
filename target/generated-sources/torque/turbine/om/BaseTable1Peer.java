 ...
 *
 */
public abstract class BaseTable1Peer
    extends BasePeer
{
    /** Serial version */
     ...
     * @deprecated Torque.getMapBuilder(Table1MapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(Table1MapBuilder.CLASS_NAME);
    }

    /** the column name for the test_col1 field */
    public static final String TEST_COL1;
    /** the column name for the test_col2 field */
    public static final String TEST_COL2;
    ...
    static
    {
        ...
        TEST_COL1 = "table1.test_col1";
        TEST_COL2 = "table1.test_col2";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(Table1MapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(Table1MapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Table1> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static void addSelectColumns(Criteria criteria)
            throws TorqueException
    {
        criteria.addSelectColumn(TEST_COL1);
        criteria.addSelectColumn(TEST_COL2);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Table1 row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Table1 obj = (Table1) cls.newInstance();
            Table1Peer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            obj.setTestCol1(row.getValue(offset + 0).asInt());
            obj.setTestCol2(row.getValue(offset + 1).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Table1> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Table1> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Table1> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Table1> results = new ArrayList<Table1>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(Table1Peer.row2Object(row, 1,
                Table1Peer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Table1> doSelect(Table1 obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Table1 obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Table1 obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Table1 obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Table1) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Table1 obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Table1) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Table1 obj, Connection con)
        throws TorqueException
    {
        throw new TorqueException(
                "doUpdate does not work for objects without primary key");
     ...
     * otherwise use the doDelete(Table1) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Table1 obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Table1 obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        criteria.add(TEST_COL1, obj.getTestCol1());
        criteria.add(TEST_COL2, obj.getTestCol2());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Table1 obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(TEST_COL1, obj.getTestCol1());
            criteria.add(TEST_COL2, obj.getTestCol2());
